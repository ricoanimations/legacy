...
function setDefaultValues(remoteConfig) {
    remoteConfig.defaultConfig = {
        "SettingsV5": JSON.stringify({
            ...
            "competitive_modes": [
                ["1v1_Competitive", "Teams_2v2_Competitive"]
            ],
            "casual_modes": [
            ...
            "custom_modes": [
                ["1v1_Custom", "Deathmatch_Custom", "MiniBoxFight_Custom", "BoxFight_Custom", "Zone_Custom", "Vikings_Custom", "PipeRun_Custom", "City_ZoneWars_Custom"]
            ],
