! function(e, t) {
    ...
    try {
        (function() {
            ...
            g(_, "_index", ["name", "keyPath", "multiEntry", "unique"]), y(_, "_index", IDBIndex, ["get", "getKey", "getAll", "getAllKeys", "count"]), b(_, "_index", IDBIndex, ["openCursor", "openKeyCursor"]), g(m, "_cursor", ["direction", "key", "primaryKey", "value"]), y(m, "_cursor", IDBCursor, ["update", "delete"]), ["advance", "continue", "continuePrimaryKey"].forEach(function(n) {
                n in IDBCursor.prototype && (m.prototype[n] = function() {
                    var t = this,
                        e = arguments;
                    return Promise.resolve().then(function() {
                        return t._cursor[n].apply(t._cursor, e), h(t._request).then(function(e) {
            ...
            }, g(E, "_store", ["name", "keyPath", "indexNames", "autoIncrement"]), y(E, "_store", IDBObjectStore, ["put", "add", "delete", "clear", "get", "getAll", "getKey", "getAllKeys", "count"]), b(E, "_store", IDBObjectStore, ["openCursor", "openKeyCursor"]), w(E, "_store", IDBObjectStore, ["deleteIndex"]), S.prototype.objectStore = function() {
                return new E(this._tx.objectStore.apply(this._tx, arguments))
            }, g(S, "_tx", ["objectStoreNames", "mode"]), w(S, "_tx", IDBTransaction, ["abort"]), I.prototype.createObjectStore = function() {
                return new E(this._db.createObjectStore.apply(this._db, arguments))
            }, g(I, "_db", ["name", "version", "objectStoreNames"]), w(I, "_db", IDBDatabase, ["deleteObjectStore", "close"]), T.prototype.transaction = function() {
                return new S(this._db.transaction.apply(this._db, arguments))
            }, g(T, "_db", ["name", "version", "objectStoreNames"]), w(T, "_db", IDBDatabase, ["close"]), ["openCursor", "openKeyCursor"].forEach(function(i) {
                    ...
                    return f(this, function(e) {
                        switch (e.label) {
                            case 0:
                                return [4, i.json()];
                            case 1:
                                return t = e.sent(), n = t.error, [2, x.create("request-failed", {
                                    requestName: r,
                                    serverCode: n.code,
                    ...
                    return f(this, function(e) {
                        switch (e.label) {
                            case 0:
                                return t = te(i), [4, Y()];
                            case 1:
                                return n = e.sent(), [4, (r = n.transaction(J, "readwrite")).objectStore(J).put(o, t)];
                            case 2:
                    ...
                    return f(this, function(e) {
                        switch (e.label) {
                            case 0:
                                return t = te(i), [4, Y()];
                            case 1:
                                return n = e.sent(), [4, (r = n.transaction(J, "readwrite")).objectStore(J).delete(t)];
                            case 2:
                                return e.sent(), [4, r.complete];
                            case 3:
                                return e.sent(), [2]
                    ...
                    return f(this, function(e) {
                        switch (e.label) {
                            case 0:
                                return t = te(s), [4, Y()];
                            case 1:
                                return n = e.sent(), r = n.transaction(J, "readwrite"), [4, (i = r.objectStore(J)).get(t)];
                            case 2:
            ...
            function ae(i, o) {
                return void 0 === o && (o = !1), c(this, void 0, void 0, function() {
                    var r, t, n;
                    return f(this, function(e) {
                        switch (e.label) {
                            case 0:
                                    ...
                                    return r = function(i, o) {
                                        return c(this, void 0, void 0, function() {
                                            ...
                                            return f(this, function(e) {
                                                switch (e.label) {
                                                    case 0:
                                                        return e.trys.push([0, 3, , 8]), [4, oe(i, o)];
                                                    case 1:
                                                        return t = e.sent(), r = s(s({}, o), {
                                                            authToken: t
                                                        }), [4, Q(i, r)];
                                                    case 2:
                                                        return e.sent(), [2, t];
                                        ...
                                        return f(this, function(e) {
                                            switch (e.label) {
                                                case 0:
                                                    return [4, ne(i)];
                                                case 1:
                                                    return t = e.sent(), n = t.installationEntry, (r = t.registrationPromise) ? [4, r] : [3, 3];
                                                case 2:
                                                    return e.sent(), [3, 4];
                                                case 3:
                                ...
                                return f(this, function(e) {
                                    switch (e.label) {
                                        case 0:
                                            return [4, ne(t = q(o))];
                                        case 1:
                                            return n = e.sent(), r = n.installationEntry, (i = n.registrationPromise) && i.catch(function() {}), 2 === r.registrationStatus && ae(t).catch(function() {}), [2, r.fid]
                                    }
                                })
                            })
                        }(t)
            ...
            function _e(e, n, t) {
                ...
                return window[t] && "function" == typeof window[t] && (r = window[t]), window[t] = function(d, p) {
                    return function(e, t, n) {
                        if (e === le.EVENT) {
                            var r = [];
                            if (n && n.send_to) {
                            ...
                            (p[t] || Promise.resolve()).then(function() {
                                d(le.CONFIG, t, n)
                            }).catch(function(e) {
                                return console.error(e)
                            })
            ...
            function ke(e) {
                ...
                e.dataLayerName && (Ce = e.dataLayerName), e.gtagName && (Oe = e.gtagName)
            }
            ...
            function Ae(t, e) {
                ...
                if (!Ne) {
                    be(Ce) || function(e) {
                            ...
                            t.src = "https://www.googletagmanager.com/gtag/js?l=" + e, t.async = !0, document.head.appendChild(t)
                        }(Ce),
                        function(e) {
                    ...
                    return c(this, void 0, void 0, function() {
                        ...
                        return f(this, function(e) {
                            switch (e.label) {
                                ...
                                case 1:
                                    return t = e.sent(), i("js", new Date), i(le.CONFIG, r.options[ge], ((n = {})[ye] = t, n[we] = "firebase", n.update = !0, n)), [2]
                            }
                        })
                    })
                }(t, me);
        ...
        throw console.error(e), new Error("Cannot instantiate firebase-analytics - be sure to load firebase-app.js first.")
    }
});
