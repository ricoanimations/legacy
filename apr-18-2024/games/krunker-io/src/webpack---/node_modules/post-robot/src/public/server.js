...
export function listen(options: ServerOptionsType): {
    cancel: () => void
} {
    ...
    let requestListener = addRequestListener({
        name,
        win,
        domain
    }, listenerOptions);
...
export function on(name: string, options: ServerOptionsType | HandlerType, handler: ? HandlerType): {
    cancel: () => void
} {
...
export function once(name: string, options: ? (ServerOptionsType | HandlerType) = {}, handler : ? HandlerType): ZalgoPromise < {
    source: mixed,
    origin: string,
    data: Object
} > {
...
export function listener(options: ServerOptionsType = {}): {
    on: (name: string, handler: HandlerType) => {
        cancel: () => void
    }
} {
