...
type Angular2 = {
    Component: ({
        ...
        Class: ({
            constructor: Array < Angular2Injection | Function > ,
            ngOnInit: () => void,
            ngOnChanges: () => void
        }) => Angular2Component
    },
    NgModule: ({
        declarations: Array < Angular2Component > ,
        exports: Array < Angular2Component >
    }) => {
        Class: ({
            constructor: () => void
        }) => Angular2Module
...
export let angular2: ComponentDriverType < * , Angular2 > = {
    ...
    register(zoid: Component < * > , {
        ...
        let getProps = (component) => {
            return replaceObject({ ...component.internalProps,
                ...component.props
            }, {
                'function': (value) => {
