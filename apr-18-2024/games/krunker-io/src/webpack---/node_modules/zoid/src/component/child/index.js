...
export class ChildComponent < P > extends BaseComponent < P > {
    ...
    getInitialProps(): (BuiltInPropsType & P) {
        ...
        return deserializeFunctions(props, ({
            fullKey,
            self,
            args
        }) => {
    ...
    */
    ...
    sendToParent(name: string, data: ? Object = {}, options : ? Object = {}): ZalgoPromise < {
        origin: string,
        ...
        return send(parentWindow, name, data, {
    ...
    */
    ...
    resize(width: ? number, height : ? number): ZalgoPromise < void > {
        return ZalgoPromise.resolve().then(() => {
            ...
            return this.sendToParent(POST_MESSAGE.RESIZE, {
                width,
                height
            }).then(noop);
        });
