...
import {
    WeakMap
} from 'cross-domain-safe-weakmap/src';
...
export function popup(url: string, options: {
    [string]: mixed
...
export function extendQuery(originalQuery: string, props: {
    [string]: string
} = {}): string {
...
export function getCurrentDimensions(el: HTMLElement): {
    width: number,
    height: number
} {
    return {
...
export function changeStyle(el: HTMLElement, styles: {
    [string]: string
}): ZalgoPromise < void > {
...
export function setOverflow(el: HTMLElement, value: string = 'auto'): {
    reset: () => void
} {
...
export function trackDimensions(el: HTMLElement, {
    width = true,
    height = true,
    threshold = 0
}: {
...
export function onDimensionsChange(el: HTMLElement, {
    width = true,
    height = true,
    delay = 50,
    threshold = 0
...
export function dimensionsMatchViewport(el: HTMLElement, {
    width,
    height
}: {
    width: number,
...
export function jsxDom(name: string, props: ? {
    [string]: mixed
}, content : ElementRefType): HTMLElement {
