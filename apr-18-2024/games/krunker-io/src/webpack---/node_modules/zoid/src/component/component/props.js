...
export type BuiltInPropsDefinitionType < P > = {
    env: StringPropDefinitionType < envPropType,
    P > ,
    uid: StringPropDefinitionType < uidPropType,
    P > ,
    url: StringPropDefinitionType < urlPropType,
    P > ,
    version: StringPropDefinitionType < versionPropType,
    P > ,
    timeout: NumberPropDefinitionType < timeoutPropType,
    P > ,
    logLevel: StringPropDefinitionType < logLevelPropType,
    P > ,
    dimensions: ObjectPropDefinitionType < dimensionsPropType,
    P > ,
    win: ObjectPropDefinitionType < winPropType,
    P > ,

    onDisplay: FunctionPropDefinitionType < onDisplayPropType,
    P > ,
    onEnter: FunctionPropDefinitionType < onEnterPropType,
    P > ,
    onRender: FunctionPropDefinitionType < onRenderPropType,
    P > ,
    onClose: FunctionPropDefinitionType < onClosePropType,
    P > ,
    onDestroy: FunctionPropDefinitionType < onDestroyPropType,
    P > ,
    onResize: FunctionPropDefinitionType < onResizePropType,
    P > ,
    onTimeout: FunctionPropDefinitionType < onTimeoutPropType,
    P > ,
    onError: FunctionPropDefinitionType < onErrorPropType,
    P >
};
