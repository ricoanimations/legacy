...
export class ParentComponent < P > extends BaseComponent < P > {
    ...
    constructor(component: Component < P > , context: string, {
        props
    }: {
        props: (PropsType & P)
    }) {
    ...
    render(element: ElementRefType, loadUrl: boolean = true): ZalgoPromise < ParentComponent < P >> {
        return this.tryInit(() => {
            ...
            this.component.log(`render_${ this.context }`, {
                context: this.context,
                element,
                loadUrl: stringify(loadUrl)
            });
            ...
            tasks.listen = ZalgoPromise.hash({
    ...
    renderTo(win: CrossDomainWindowType, element: ? string): ZalgoPromise < ParentComponent < P >> {
        return this.tryInit(() => {
            ...
            this.component.log(`render_${ this.context }_to_win`, {
    ...
    getRenderParentRef(renderToWindow: CrossDomainWindowType = window): {
        ref: string,
        uid ? : string,
        distance ? : number
    } {
    ...
    buildChildWindowName({
        ...
        renderTo: CrossDomainWindowType
    } = {}): string {
    ...
    */
    ...
    sendToParent(name: string, data: Object): ZalgoPromise < {
        origin: string,
        ...
        return send(getParentComponentWindow(), name, data, {
    ...
    */
    ...
    buildUrl(): ZalgoPromise < string > {
        ...
        return ZalgoPromise.all([
            ...
            propUrl,
            // $FlowFixMe
            propsToQuery({ ...this.component.props,
    ...
    */
    ...
    listeners(): {
        [string]: (CrossDomainWindowType, Object) => mixed
    } {
        return {
            ...
            [POST_MESSAGE.INIT](source: CrossDomainWindowType, data: Object): {
                props: BuiltInPropsType & P,
                context: string
            } {
        ...
        return ZalgoPromise.try(() => {
            ...
            return ZalgoPromise.try(() => {
                ...
                try {
                    ...
                    this.component.logError('preprender_error', {
                ...
                let {
                    width = false, height = false, element = 'body'
                } = (typeof this.component.autoResize === 'object' && this.component.autoResize !== null) ?
