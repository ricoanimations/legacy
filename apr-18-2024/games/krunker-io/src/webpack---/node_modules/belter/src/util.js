...
export function memoize < F: Function > (method: F, options ? : MemoizeOptions = getDefaultMemoizeOptions()): Memoized < F > {
    const {
        thisNamespace = false, time: cacheTime
    } = options;
...
export function inlineMemoize < R > (method: (...args: $ReadOnlyArray < any > ) => R, logic: (...args: $ReadOnlyArray < any > ) => R, args: $ReadOnlyArray < any > = []): R {
    ...
    } = method.__inline_memoize_cache__ = method.__inline_memoize_cache__ || {};
...
export const memoizedValues: < T > ({
    [string]: T
}) => $ReadOnlyArray < T > = memoize(values);
...
export function objFilter < T, R > (obj: {
    [string]: T
...
export function dotify(obj: Object, prefix: string = '', newobj: Object = {}): {
    [string]: string
} {
...
export const constHas = < X: (string | boolean | number),
    T: {
        [string]: X
    } > (constant: T, value: X): boolean => {
