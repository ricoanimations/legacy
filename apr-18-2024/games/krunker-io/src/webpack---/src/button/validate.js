...
import {
    ...
    ALLOWED_INSTALLMENT_COUNTRIES,
    ALLOWED_INSTALLMENT_PERIOD,
    LOCALE
} from '../constants';
...
export function validateButtonStyle(style: Object = {}, props: Object) {
    ...
    const {
        [BUTTON_STYLE_OPTIONS.COLOR]: color, [BUTTON_STYLE_OPTIONS.SHAPE]: shape, [BUTTON_STYLE_OPTIONS.SIZE]: size, [BUTTON_STYLE_OPTIONS.BRANDING]: branding, [BUTTON_STYLE_OPTIONS.FUNDINGICONS]: fundingicons, [BUTTON_STYLE_OPTIONS.TAGLINE]: tagline, [BUTTON_STYLE_OPTIONS.LAYOUT]: layout, [BUTTON_STYLE_OPTIONS.MAXBUTTONS]: maxbuttons, [BUTTON_STYLE_OPTIONS.HEIGHT]: height
    } = style;
