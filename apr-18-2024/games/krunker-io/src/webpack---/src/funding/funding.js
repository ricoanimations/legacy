...
export function isFundingIneligible(source: FundingSource, {
    locale,
    funding,
    layout,
    commit,
...
export function isFundingAutoEligible(source: FundingSource, {
    locale,
    funding,
    layout
}: {
...
export function isFundingEligible(source: FundingSource, {
    locale,
    funding,
    env,
    layout,
    ...
    const ineligibleReason = isFundingIneligible(source, {
        locale,
        funding,
        layout,
        commit,
    ...
    const autoEligibleReason = isFundingAutoEligible(source, {
        locale,
        funding,
        layout
    });
...
export function determineEligibleCards({
    funding,
    locale
}: {
    funding: FundingSelection,
...
export function validateFunding(funding: FundingSelection = {
    allowed: [],
    disallowed: [],
    remembered: []
}) {
