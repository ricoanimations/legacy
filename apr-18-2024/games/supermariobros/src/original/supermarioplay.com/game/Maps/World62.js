map.locs = [new Location(0, true), new Location(0, exitPipeVert), new Location(0, exitPipeVert), new Location(0, false, 1304), new Location(0, exitPipeVert), new Location(1), new Location(2), new Location(3, enterCloudWorld), new Location(4)];
map.areas = [new Area("Overworld Night", function() {
